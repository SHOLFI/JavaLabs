...
public class Lab4 extends JFrame{
    ...
    public Lab4() {
        ...
        saveText.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                int result = fileChooser.showSaveDialog(Lab4.this);
        ...
        loadText.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                JFileChooser fileChooser = new JFileChooser();
                int result = fileChooser.showOpenDialog(Lab4.this); // вызываем диалоговое окно для выбора файла.
                if (result == JFileChooser.APPROVE_OPTION) {
                    File file = fileChooser.getSelectedFile();
    ...
    public class RecIntegralException extends Exception {
        public RecIntegralException(String message) {
            JOptionPane.showMessageDialog(Lab4.this, message);
        }
    }
    ...
    public static void main(String[] args) {
        new Lab4(); // создаем экземпляр приложения
    }
}